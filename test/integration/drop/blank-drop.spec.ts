...
describe('drop/blank-drop', function () {
  ...
  it('render blank drop as blank string', async function () {
    const html = liquid.parseAndRenderSync('{{blank}}')
    expect(html).toBe('')
  })
